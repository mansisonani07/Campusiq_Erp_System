...
from ..services import risk_score, recommendation_from_risk, dashboard_metrics, fee_reminders
...
def log_action(db, request, action, details=""):
    """Helper function to log admin actions to audit log"""
    try:
        log = models.AuditLog(
            user_id=request.session.get("user_id"),
            user_name=request.session.get("name", "Unknown"),
            action=action,
            details=details,
