...
def emit_dev_otp(message: str) -> None:
    ...
    # Force unbuffered output to stdout first
    sys.stdout.flush()
    try:
        # Try direct file descriptor write to stdout
        stdout_fd = sys.stdout.fileno()
        os.write(stdout_fd, output.encode('utf-8'))
    except Exception:
        pass
    ...
    # Use print with force flush
    print(output, flush=True)
    
    # Use logging at ERROR level which uvicorn ALWAYS shows
    otp_logger.error("OTP: " + message)
